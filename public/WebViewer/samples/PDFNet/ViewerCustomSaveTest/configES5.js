...
(function() {
  var mergeAndSave = function(doc, xfdf) {
    ...
    function main() {
      var fdf_doc, pitr, page, i, annot_obj, docbuf;

      return regeneratorRuntime.wrap(function main$(context$3$0) {
        while (1) switch (context$3$0.prev = context$3$0.next) {
        case 0:
          context$3$0.next = 2;
          return PDFNet.FDFDoc.createFromXFDF(xfdf);
        case 2:
        ...
        case 22:
          ...
          context$3$0.next = (context$3$0.t0 === PDFNet.Annot.Type.e_Widget ? 25 : (context$3$0.t0 === PDFNet.Annot.Type.e_Link ? 25 : (context$3$0.t0 === PDFNet.Annot.Type.e_Sound ? 25 : (context$3$0.t0 === PDFNet.Annot.Type.e_Movie ? 25 : (context$3$0.t0 === PDFNet.Annot.Type.e_FileAttachment ? 25 : 26)))));
          break;
        case 25:
        ...
        case 45:
          ...
          return context$3$0.abrupt("return", docbuf);
        case 47:
        case "end":
          return context$3$0.stop();
        }
      }, marked2$0[0], this, [[9, 32]]);
    }
    // start the generator
