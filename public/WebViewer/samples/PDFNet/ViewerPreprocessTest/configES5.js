...
(function() {
  ...
  function runScript() {
    var marked2$0 = [ModAnnotations, main].map(regeneratorRuntime.mark);
    function ModAnnotations(doc) {
      var imagefile, apWriter, apBuilder, sigImg, itr, page, num_annots, num_mod, i, annot, annotType, w, h, apElement, apObj;

      return regeneratorRuntime.wrap(function ModAnnotations$(context$3$0) {
        while (1) switch (context$3$0.prev = context$3$0.next) {
        case 0:
          imagefile = '../../samples/PDFNet/TestFiles/grayscale.tif';
          context$3$0.next = 3;
        ...
        case 34:
          ...
          return context$3$0.abrupt("continue", 74);
        case 36:
          context$3$0.next = 38;
          return annot.getType();
        case 38:
          annotType = context$3$0.sent;
          context$3$0.t0 = annotType;
          context$3$0.next = (context$3$0.t0 === PDFNet.Annot.Type.e_Stamp ? 42 : 73);
          break;
        case 42:
          apWriter.begin(doc);
          context$3$0.next = 45;
        ...
        case 65:
          ...
          apObj.putName('Type', 'XObject');
          context$3$0.next = 71;
          return annot.setAppearance(apObj);
        case 71:
          num_mod += 1;
          return context$3$0.abrupt("break", 74);
        case 73:
          return context$3$0.abrupt("break", 74);
        case 74:
          ++i;
